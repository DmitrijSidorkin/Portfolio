    ...
    <MenuCard>
      <div className="flex flex-col p-5 gap-3">
        <p>
          ...
          with “The Web Developer Bootcamp”, which provided me with essential
          web development skills. I put these fundamentals to test by working on
          a rather sizable personal project, which helped me strengthening my
